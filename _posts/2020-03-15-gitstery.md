...
classes: wide
header:
    overlay_image: /assets/images/thumb-image-v2.jpg
    overlay_filter: 0.5
    teaser: /assets/images/thumb-image-v2.jpg
...
<figure>
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/gitstery/gitstery-files.png">
...
<figure>
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/gitstery/gitstery-log-July-24.png">
...
```
<figure>
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/gitstery/gitstery-kpumbineer-branch-files.png">
...
<figure>
    <img src=""{{ site.url }}{{ site.baseurl }}/assets/images/gitstery/git-blame-grep.png">
...
```
<figure>
<img src="https://giffiles.alphacoders.com/253/25386.gif" alt="YES YES YES!" />
<figcaption>We solved the case!</figcaption>
</figure>
